...
const LazyNews = React.lazy((): any => import('./News'));
        ...
        <View
          ...
          <View
            ...
            <React.Suspense fallback={<LoadingSpinner />}>
              ...
              />
              <LazyNews items={_.take(news, 5)} onPress={onNewsPress} navigateTo={navigateToScreen} />
            </React.Suspense>
          </View>
        </View>
      </View>
  ...
  return (
    <View style={styles.container}>
      <View style={styles.welcome}>
        {!isRefreshingPrice ? (
          <Image
            source={require('../assets/coinbase.png')}
        ...
        <Text style={styles.title}>Welcome to Cryptostream App!</Text>
        <Text style={[styles.subTitle, { paddingBottom: verticalScale(20) }]}>Make your first investment today</Text>
        <View>
          <TouchableOpacity
            style={{
              zIndex: -1,
